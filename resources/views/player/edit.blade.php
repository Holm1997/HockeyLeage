...
<form action="{{ route('players.update', $player->id) }}" method="post">
    ...
    <div class="mb-3 col-3">
        ...
        <input name="last_name" type="text" class="form-control border-secondary" id="last_name" value="{{ $player->last_name }}">
    </div>

    <div class="mb-3 col-3">
        <label for="first_name" class="form-label">Имя игрока</label>
        <input name="first_name" type="text" class="form-control border-secondary" id="first_name" value="{{ $player->first_name }}">
    </div>

    <div class="mb-3 col-2">
        <label for="birthday" class="form-label">Дата рождения</label>
        <input name="birthday" type="text" class="form-control border-secondary" id="birthday" value="{{ $player->birthday }}">
    </div>
